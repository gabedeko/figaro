...
<div class="landing-wrapper" style="background-image:url(@asset('images/placeholder/figaro_placeholder_5.jpg'))">
  <div class="landing-wrapper-container">
    <h1 class="display-4 landing-wrapper-title">Figaro Facials</h1>
    <hr class="my-3">
    <p class="lead leading-wrapper-copy">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ut ornare arcu, non elementum ex.</p>
  </div>
</div>
...
<div class="container-fluid figaro-slider-container">
  <div class="row">
    <div class="col-md-3">
      <h2 class="figaro-slider-title">Services</h2>
    </div>
    <div class="col-md-9">
        <div class="container-fluid figaro-slider-row">
            <a class="figaro-slider" href="">
                <div class="figaro-slider-img" style="background-image:url(@asset('images/placeholder/figaro_placeholder_1.jpg'))"></div>
...
<div class="row justify-content-end">
    <div class="col-md-3">
      ...
      <div class="figaro-mod-1-img" style="background-image:url(@asset('images/placeholder/figaro_placeholder_3.jpg'))"></div>
    </div>
    <div class="col-md-5">
      <div class="figaro-mod-1-img" style="background-image:url(@asset('images/placeholder/figaro_placeholder_6.jpg'))"></div>
    ...
    <div class="col-md-2">
      <div class="figaro-mod-1-img" style="background-image:url(@asset('images/placeholder/figaro_placeholder_9.jpg'))"></div>
    </div>
  </div>
</div>
